...
from kuning.views import add_transaction, subscribe_menu, subscribe_form, subscribe_history, downloaded_songs, delete_downloaded_song, search_content, search_found

app_name = 'kuning'

urlpatterns = [
    path('subscribe_menu', subscribe_menu, name='subscribe_menu'),
    path('subscribe_form/<int:id>/', subscribe_form, name='subscribe_form'),
